...
mongoose
  .connect("mongodb://localhost/catsDB")
  .then(() => console.log("Connected to MongoDB..."))
  .catch((err) => console.log("Couldn't connect to MongoDB...", err));
// Welcome Page
app.get("/", (req, res) => {
  res.send(
    "Welcome to Cats in the Sky! Our highly scientific studies showed us that milk was 87% ineffective for feline health. That's why we believe in serving fresh vegetables to all our cats at high altitudes."
  );
});
